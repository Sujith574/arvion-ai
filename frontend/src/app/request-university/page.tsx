    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                else if (Array.isArray(data.detail)) msg = data.detail.map((d: any) => d.msg || d.message || JSON.stringify(d)).join(", ");
                else if (data.detail && typeof data.detail === "object") msg = JSON.stringify(data.detail);
                ...
                <div style={{ background: "linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%)", padding: "3rem 1.5rem", color: "white", textAlign: "center" }}>
                    <div style={{ maxWidth: "640px", margin: "0 auto" }}>
                        ...
                        <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "1rem", lineHeight: 1.7, margin: 0 }}>
                            Don&apos;t see your university on Arvix AI? Submit a request and we&apos;ll work on onboarding it.
                ...
                <div style={{ maxWidth: "680px", margin: "2.5rem auto", padding: "0 1.25rem 4rem" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1rem", marginTop: "1.5rem" }}>
                        {[
                            ...
                            { icon: "🆓", title: "Always Free", desc: "Arvix AI is free for students and parents" },
                        ].map((item) => (
