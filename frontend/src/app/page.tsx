    ...
    <>
      ...
      <main style={{ overflowX: "hidden" }}>
        ...
        <section id="features" style={{ padding: "6rem 1.5rem" }}>
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              <p style={{ fontSize: "0.875rem", fontWeight: 700, color: "var(--brand-600)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.75rem" }}>Why Arvix AI</p>
        ...
        <section style={{ padding: "6rem 1.5rem", textAlign: "center" }}>
          <div style={{ maxWidth: "600px", margin: "0 auto" }}>
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: "1.0625rem", marginBottom: "2.5rem", lineHeight: 1.7 }}>
              Join thousands of students and parents who use Arvix AI every day.
            </p>
      ...
      <style>{`
        ...
        /* ΓöÇΓöÇ Mobile First Overrides ΓöÇΓöÇ */
